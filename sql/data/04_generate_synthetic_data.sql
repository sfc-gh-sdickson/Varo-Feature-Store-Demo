...
(feature_id, feature_name, feature_group, description, data_type, computation_type, computation_logic, data_sources, refresh_frequency, version, is_active, created_by, created_at, updated_at)
SELECT 
...
(feature_set_id, feature_set_name, model_name, description, feature_ids, is_active, created_by, created_at, updated_at)
SELECT 
...
(document_id, document_type, title, content, effective_date, tags, created_at)
SELECT 
